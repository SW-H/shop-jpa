...
class OrderServiceTest {
	...
	public void 상품주문() throws Exception {
		...
		Book book = createBook("JPA master", 20000, 10);
	...
	private Member createMember() {
		...
		member.setName("한승원");
		member.setAddress(new Address("서울", "강남", "12331"));
